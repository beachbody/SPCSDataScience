...
##### **REMEMBER TO OPEN JUPYTER AND NAVIGATE TO NBS/index.ipynb and run the commands in the notebook. This will allow everything to work seamlessly.**
...
> If you don’t have your environment variables ready, you can create a
> `demo_auth.json`. You will need to use
> `load_credentials('demo_auth.json')` in `create_snowflake_session()`.
