...
> [!NOTE]
>
> ### Wrap Execute Service In Snowflake Task
>
> ``` sql
>
...
> **WARNING**: This is intended for development purposes only and has
> not been approved by security or infosec for deployment. If you plan
> to deploy this, be aware of the risks, as it has not been fully
> secured. Please consult with your data governance teams to ensure safe
> deployment.

## Why?

As a 8+ year data scientist and machine learning engineer during my time
this is what we wanted to be able to do in snowflake and now with SPCS
we can do all of our needs inside of snowflake not needing to move to a
different platform. I have always followed the notebook development
approach that Fast.ai has done through great works of nbdev so what you
are going to see is a jupyter notebook development first apporach to
doing development inside of snowflake. Jeremy Howard is an amazing
mentor to so many excellent open source developers and I wanted to make
sure to thank him for everything he has put in the community. Now you
might not agree with this development approach and that is okay. This
does not mean that you can’t change what you are seeing to be in your
IDE of choice you can change the docker image to support VS code and
work through VS code. We are going to leverage jupyter lab to make this
accessible to everyone in future versions there will most likey be one
that is support the VS code set up. This intial jupyter lab set up is
going to support just python, but you can easily add R studio, scala or
many other methods of approach you believe fits your development
prefence.
